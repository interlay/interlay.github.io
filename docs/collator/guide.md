...
```shell
wget https://github.com/interlay/interbtc/releases/download/1.12.1/interbtc-parachain
...
```shell
wget https://github.com/interlay/interbtc/releases/download/1.12.1/interbtc-standalone
