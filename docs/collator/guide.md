...
```shell
wget https://github.com/interlay/interbtc/releases/download/1.9.6/interbtc-parachain
...
```shell
wget https://github.com/interlay/interbtc/releases/download/1.9.6/interbtc-standalone
