...
<details>
<summary>
Run Bitcoin and the Vault binary as a service on your computer or server. Best if you are mostly interested in operating a Vault for earning PolkaBTC and participating in the protocol.
</summary>
