...
```shell
wget https://github.com/interlay/polkabtc-clients/releases/download/0.7.9/staked-relayer
```
...
Clone the Relayer code, checkout release `0.7.9`, and build the client:
