...
```shell
wget https://github.com/interlay/polkabtc-clients/releases/download/0.7.6/staked-relayer
```
...
Clone the Relayer code, checkout release `0.7.6`, and build the client:
