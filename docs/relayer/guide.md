...
```shell
wget https://github.com/interlay/polkabtc-clients/releases/download/0.5.8/staked-relayer
```
...
Clone the Relayer code, checkout release `0.5.8`, and build the client:
